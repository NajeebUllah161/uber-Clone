        ...
        <View style={styles.container}>
            ...
            <ScrollView bounces={false}>
                <View style={styles.home}>
                    {/* style={{...styles.text1,paddingTop:-5}} */}
                ...
                <View style={{ ...styles.view5, borderBottomWidth: 0 }}>
                    <View style={styles.view6}>
                        ...
                        <View>
                            <Text style={{ fontSize: 18, color: colors.black }}>Makkah Street</Text>
                            <Text style={{ color: colors.grey3 }}>Habib Ullah Colony, Abbottabad</Text>
                        </View>
                    </View>
                    <View>
                        <Icon
                ...
                {/* style={{ ...styles.text4, marginTop: -1.5 }} */}
